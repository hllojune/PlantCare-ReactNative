            ...
            <View style={styles.sparklineContainer}>
              {[20, 22, 21, 23, 22, 22.5, 22, 21.5, 22, 22.5].map((val, i) => (
                <View
                  ...
                  style={[
                    styles.sparklineBar,
                    { backgroundColor: '#FED7AA', height: `${(val / 24) * 100}%` },
                  ]}
                />
              ))}
            </View>
            ...
            <View style={styles.sparklineContainer}>
              {[58, 60, 62, 64, 63, 65, 66, 64, 65, 65].map((val, i) => (
                <View
                  ...
                  style={[
                    styles.sparklineBar,
                    { backgroundColor: '#BFDBFE', height: `${(val / 80) * 100}%` },
                  ]}
                />
              ))}
            </View>
            ...
            <View style={styles.sparklineContainer}>
              {[70, 69, 68, 68, 67, 68, 68, 67, 68, 68].map((val, i) => (
                <View
                  ...
                  style={[
                    styles.sparklineBar,
                    { backgroundColor: 'rgba(124, 203, 138, 0.4)', height: `${(val / 80) * 100}%` },
                  ]}
                />
              ))}
            </View>
...
const styles = StyleSheet.create({
  ...
  sparklineContainer: {
    flexDirection: 'row',
    alignItems: 'flex-end', // 바닥을 기준으로 그래프가 올라가도록
    gap: 4,
    height: 48, // h-12
  },
  sparklineBar: {
