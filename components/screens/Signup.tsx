...
import {
  ...
  SafeAreaView, KeyboardAvoidingView, Platform, ScrollView, StatusBar, Alert,
} from 'react-native';
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.flex1}>
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            <View style={styles.logoSection}>
              ...
              <Text style={styles.subtitle}>SPPKL의 디지털 온실에서 식물 집사 생활을 시작해보세요.</Text>
            </View>
            ...
            <View style={styles.formCard}>
              ...
              <View style={styles.inputGroup}>
                ...
                <Text style={styles.helperText}>영문, 숫자, 특수문자를 포함하여 8자 이상이어야 합니다.</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  logoCircle: {
    ...
    backgroundColor: '#e8f5e9', alignItems: 'center', justifyContent: 'center', marginBottom: 20,
  },
  title: { fontSize: 26, fontWeight: '800', color: '#111827', textAlign: 'center', marginBottom: 8 },
  subtitle: { fontSize: 14, color: '#6B7280', textAlign: 'center', lineHeight: 20 },
  formCard: {
    backgroundColor: '#ffffff', borderRadius: 32, padding: 24, gap: 20,
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 12,
    elevation: 3, borderWidth: 1, borderColor: '#F3F4F6', marginBottom: 32,
  },
  ...
  submitButton: {
    flexDirection: 'row', backgroundColor: '#2d5a27',
    height: 60, borderRadius: 18, alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 10,
  },
