...
import { LinearGradient } from 'expo-linear-gradient'; // Expo용 그라데이션
...
const slides = [
  {
    image: 'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=800', // 임시 이미지 주소
    title: "실시간 정원 모니터링",
...
export function Onboarding({ onNavigate }: OnboardingProps) {
  ...
  const handleNext = () => {
    if (isLast) {
      onNavigate('Login'); // 마지막 슬라이드에서 로그인 화면으로 이동
    } else {
